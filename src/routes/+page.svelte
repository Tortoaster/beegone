<script lang="ts">
  ...
  let board: (Piece | null | undefined)[][] = [
    [undefined, undefined, undefined, null, {type: "Bee", content: [Color.Dark, Species.Nurse]}, null, {type: "Bee", content: [Color.Dark, Species.Drone]}],
    [undefined, undefined, {type: "Wall", content: undefined}, null, null, {type: "Bee", content: [Color.Dark, Species.Queen]}, null],
    [undefined, {type: "Wall", content: undefined}, {type: "Wall", content: undefined}, {type: "Wall", content: undefined}, null, null, {type: "Bee", content: [Color.Dark, Species.Nurse]}],
    [null, null, {type: "Wall", content: undefined}, {type: "Wall", content: undefined}, {type: "Wall", content: undefined}, null, null],
    [{type: "Bee", content: [Color.Light, Species.Nurse]}, null, null, {type: "Wall", content: undefined}, {type: "Wall", content: undefined}, {type: "Wall", content: undefined}, undefined],
    [null, {type: "Bee", content: [Color.Light, Species.Queen]}, null, null, {type: "Wall", content: undefined}, undefined, undefined],
    [{type: "Bee", content: [Color.Light, Species.Drone]}, null, {type: "Bee", content: [Color.Light, Species.Nurse]}, null, undefined, undefined, undefined],
  ];
  ...
  const endTurn = () => {
    selected = null;
    if (turn === Color.Light) { turn = Color.Dark } else { turn = Color.Light }
  }
            ...
            {#if board[q + BOARD_RADIUS][r + BOARD_RADIUS] !== undefined}
                <svg viewBox="0 0 300 300" x={screen_x({q, r})} y={screen_y({q, r})} width={TILE_SIZE}
                    ...
                    {#if board[q + BOARD_RADIUS][r + BOARD_RADIUS] != null}
                        <PieceComponent on:click={(_) => select({q, r})} piece={board[q + BOARD_RADIUS][r + BOARD_RADIUS]}/>
                    {/if}
                </svg>
            {/if}
        {/each}
