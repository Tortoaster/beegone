...
export const stateNew: (a: number, b: number) => void;
export const stateActionsFrom: (a: number, b: number, c: number) => void;
export const submitAction: (a: number) => number;
export const stateProgress: (a: number) => number;
export const boardGet: (a: number, b: number, c: number) => void;
export const boardPositions: (a: number) => void;
