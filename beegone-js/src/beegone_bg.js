...
export function stateActionsFrom(state, pos) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.stateActionsFrom(retptr, addHeapObject(state), addHeapObject(pos));
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        if (r2) {
...
export function submitAction(action) {
    const ret = wasm.submitAction(addHeapObject(action));
...
export function stateProgress(state) {
    const ret = wasm.stateProgress(addHeapObject(state));
    return takeObject(ret);
}
 ...
 * @param {Board} board
 * @param {Pos} pos
 * @returns {WithId<Piece> | undefined}
 */
export function boardGet(board, pos) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.boardGet(retptr, addHeapObject(board), addHeapObject(pos));
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        if (r2) {
...
export function __wbindgen_closure_wrapper284(arg0, arg1, arg2) {
